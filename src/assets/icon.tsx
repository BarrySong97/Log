...
export function MaterialSymbolsCalendarClockOutline(
...
export function SolarHashtagBold(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
